...
for i in subses:
    os.chdir(os.path.join(root_dir, i))
    sub=i.split('/')[0]
    ses=i.split('/')[1]
    sub_ses=sub+'_'+ses
    ...
    anat_dilated2_deriv='anat_dilated2'
    ...
    cc_aseg_postBN=f'work/postbibsnet/{i}/chirality_correction/corrected_{sub_ses}_optimal_resized.nii.gz'
